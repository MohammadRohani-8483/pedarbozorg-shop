...
const WhyPedarbozorgItem: React.FC<props> = ({ icon, title, description }) => {
    ...
    return (
        <motion.div
            ...
            className="lg:py-8 lg:px-6 py-2 px-5 bg-[url(/Image/background-green-vector.svg)] bg-contain bg-no-repeat bg-center w-full max-w-[265px] aspect-[265/305] flex justify-center items-center"
        ...
        >
            ...
            >
                ...
                <p className='text-gray-200 font-light w-full lg:text-sm text-[10px]'>{description}</p>
            </motion.div>
        </motion.div>
    )
}
